    ...
    return (
        <div>
            ...
            <div className="background-image">
                    ...
                    <div className="w-full h-full flex justify-center items-center">
                        ...
                        <div className="lge:block md:block mdsm:block sm:hidden">
                            <p className="uppercase font-ClearlyRomanHeavyKursiv lg:block lge:block md:block mdsm:block sm:hidden text-white lg:text-[40px] lge:text-[40px] md:text-[44px] mdsm:text-[40px] leading-tight">
                                RVS{' '}
                                <span className="lg:text-[28px] lge:text-[28px] md:text-[24px] mdsm:text-[22px]">College of Arts and Science</span>
                            </p>
                ...
                Delhi */}
                                Autonomous and Affiliated to Bharathiar University, Approved by AICTE <br />
                    ...
                    <div className="items-center justify-center lg:hidden lge:hidden sm:flex md:hidden mdsm:hidden">
                        ...
                        <img src={Logo} alt="logo" width="100" height="100" draggable="false" className="object-cover" />
                        {/* logo Mobile view end */}
                        <div className="">
                            <p className="sm:text-2xl text-white uppercase font-ClearlyRomanHeavyKursiv">Rvs cas</p>
                            {/* <p className="text-white lg:text-base lge:text-base md:text-tiny mdsm:text-tiny sm:text-[10px] font-PoppinsLight">
                ...
                Delhi
                            ...
                            <p className="text-white text-sm font-PoppinsRegular">Education for Digital Era</p>
                        </div>
                    </div>
                    {/* <img
            src={MobRVS}
          ...
          /> */}
                    ...
                    <div className="col-span-4">
                        ...
                        <div className="">
                            ...
                            <p className="lg:block lge:block md:block mdsm:block sm:hidden lg:text-h6 lge:text-h6 md:text-h6 mdsm:text-h6 sm:text-base font-PoppinsLight text-white mx-5 pb-8">
                                Accelerate your finance career with our cutting-edge MBA in Applied Finance program. Developed in collaboration with
                                Finshiksha, a leading financial education company, this comprehensive curriculum integrates advanced financial tools
                                and technical expertise, preparing you for impactful roles in the dynamic finance sector.
                            </p>
                            {/* Desktop View End */}
                            {/* Mobile View start */}
                            <p className="lg:hidden lge:hidden sm:block md:hidden mdsm:hidden lg:text-h5 lge:text-h5 md:text-h6 mdsm:text-h6 sm:text-base font-PoppinsLight text-white pl-6 px-9 pb-8">
                                Enhance your finance career with an MBA in Applied Finance and learn the current trends in Fintech.
                            </p>
                            {/* Mobile View End */}
                            <div className="">
                                <img
                        ...
                        <div className="lg:block lge:block md:block mdsm:block sm:hidden">
                            <div className="bg-white lg:p-16 lge:p-16 md:p-16 mdsm:p-16 sm:p-10 lg:mx-7 lge:mx-7 md:mx-24 mdsm:mx-24 sm:mx-6">
                                ...
                                <div className="pb-6">
                                    ...
                                    <div>{errors.name && <span className="text-red text-base sm:text-[10px]">{errors.name}</span>}</div>
                                </div>
                                <div className="pb-6">
                                    <div className="flex justify-center relative pb-1">
                                    ...
                                    <div className="">
                                        {errors.email && <span className="text-red text-base sm:text-[10px]">{errors.email}</span>}
                                    </div>
                                </div>
                                <div className="pb-6">
                                    <div className="flex justify-center relative pb-1">
                                    ...
                                    <div className="">
                                        {errors.phone && <span className="text-red text-base sm:text-[10px]">{errors.phone}</span>}
                                    </div>
                                </div>
                                <div className="">
                                    <button
            ...
            /> */}
                        ...
                        <p className="text-secondary font-PoppinsMedium lg:text-h4 lge:text-h4 md:text-h5 mdsm:text-h5 sm:text-h6">July 2024</p>
                    </div>
            ...
            /> */}
                        ...
                        >
                            <g id="Group 355">
                                <circle id="Ellipse 55" cx="40" cy="40" r="39.5" stroke="#7C0201" />
              ...
              <g id="Group 357">
                ...
                <g id="react-icons/hi/HiOutlineLocationMarker">
                  ...
                  />
                        ...
                        <p className="text-secondary font-PoppinsMedium lg:text-h4 lge:text-h4 md:text-h5 mdsm:text-h5 sm:text-h6">INR 3 to 10 LPA</p>
                    </div>
                </div>
            </div>
            <div className="py-10">
